...
cutscene_data = {
    "intro": {
        "images": [
            ...
            pygame.image.load(os.path.join('..', 'graphics', 'player', 'idle', 'player_idle.png')),
            pygame.image.load(os.path.join('..','graphics','tutorial','nach oben.png')),
            pygame.image.load(os.path.join('..','graphics','tutorial','nach unten.png')),
            pygame.image.load(os.path.join('..','graphics','tutorial','nach links.png')),
            pygame.image.load(os.path.join('..','graphics','tutorial','nach rechts.png')),
        ...
        "text": [
            ...
            "To move forward you press",
            "To move backward you press",
            "To move left you press",
            "To move right you press",
...
def play_cutscene(screen, location):
    if location == "intro":
        ...
        for idx, image in enumerate(images):
            ...
            image_rect.center = (WINDOW_WIDTH // 2.2, WINDOW_HEIGHT // 2.2)
